...
import { HiChevronRight, HiDotsVertical, HiPencilAlt, HiTrash, HiUserAdd } from "react-icons/hi";
        ...
        <div className="mt-10 sm:hidden">
          ...
          <ul className="mt-3 border-t border-gray-200 divide-y divide-gray-100">
            {projects.map((project) => (
              <li key={project.id}>
                <Link to="#" className="group flex items-center justify-between px-4 py-4 hover:bg-gray-50 sm:px-6">
                  <span className="flex items-center truncate space-x-3">
                    <span className="font-medium truncate text-sm leading-6">{project.title} </span>
                  </span>
                  <HiChevronRight className="ml-4 h-5 w-5 text-gray-400 group-hover:text-gray-500" aria-hidden="true" />
                </Link>
              </li>
            ))}
          </ul>
